...
class QuizzsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quizz" do
    assert_difference('Quizz.count') do
      post quizzs_url, params: { quizz: { category_id: @quizz.category_id, name: @quizz.name, time: @quizz.time } }
    end
  ...
  test "should update quizz" do
    patch quizz_url(@quizz), params: { quizz: { category_id: @quizz.category_id, name: @quizz.name, time: @quizz.time } }
